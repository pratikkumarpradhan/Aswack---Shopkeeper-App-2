...
import kotlinx.android.synthetic.main.activity_garage_details.progressBar
import kotlinx.android.synthetic.main.activity_garage_details.rvProduct
import kotlinx.android.synthetic.main.activity_garage_details.tvCategoryValue
import kotlinx.android.synthetic.main.activity_garage_details.tvDelete
import kotlinx.android.synthetic.main.activity_garage_details.tvDescription
import kotlinx.android.synthetic.main.activity_garage_details.tvEdit
import kotlinx.android.synthetic.main.activity_garage_details.tvName
import kotlinx.android.synthetic.main.activity_garage_details.tvPostedOnValue
import kotlinx.android.synthetic.main.activity_garage_details.tvPriceValue
import kotlinx.android.synthetic.main.activity_garage_details.tvProductCodeValue
import kotlinx.android.synthetic.main.activity_garage_details.tvSerialNumberValue
import kotlinx.android.synthetic.main.activity_spare_parts_details.*
import kotlinx.android.synthetic.main.header_title.*


class GarageDetailActivity : AppCompatActivity(), ProductsImagesAdapter.ICustomListListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mContext = this@GarageDetailActivity
        init()
        clickListener()
    }
    ...
    private fun init() {
        ...
        sparePartsCarAccesoriesDetailViewModel =
            ViewModelProvider(this).get(SparePartsCarAccesoriesDetailViewModel::class.java)
        sparePartsCarAccesoriesDetailViewModel.productList =
            Gson().fromJson(intent.getStringExtra(IntentKeyEnum.PRODUCT_LIST.name).toString(),
                ProductList::class.java)
        tvTitle.text =
            sparePartsCarAccesoriesDetailViewModel.productList.product_name + "'s details"
        ...
        tvBrandNameValue.text = sparePartsCarAccesoriesDetailViewModel.productList.vehicle_company_name
        ...
        tvSerialNumberValue.text = sparePartsCarAccesoriesDetailViewModel.productList.specialize_in
    ...
    private fun clickListener() {
        ...
        tvEdit.setOnClickListener {
            val intent = Intent(mContext, UpdateGarageProductActivity::class.java)
            intent.putExtra(IntentKeyEnum.PRODUCT_LIST.name,
                Gson().toJson(sparePartsCarAccesoriesDetailViewModel.productList))
            startActivity(intent)
            finish()
        }
