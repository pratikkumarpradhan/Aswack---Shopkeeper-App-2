...
class OfferDetailForProductsActivity : AppCompatActivity(), ProductsImagesAdapter.ICustomListListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mContext = this@OfferDetailForProductsActivity
        init()
        clickListener()
    }
    ...
    private fun init() {
        ...
        offerDetailViewModel.productList = Gson().fromJson(intent.getStringExtra(IntentKeyEnum.PRODUCT_LIST.name).toString(), ProductList::class.java)
      ...
      //  tvName.text = offerDetailViewModel.offerProductDetail.vehicle_model_name + " (" + offerDetailViewModel.offerProductDetail.vehicle_year_name + ")"
        ...
        if (offerDetailViewModel.productList.vehicle_type_name.isNullOrEmpty()){

            if (offerDetailViewModel.productList.vehicle_company_name.isNullOrEmpty()){
                tvType.visibility = View.GONE
            }else{
                tvType.text = offerDetailViewModel.productList.vehicle_company_name
            }
        }else{
            tvType.text = offerDetailViewModel.productList.vehicle_company_name + ", " + offerDetailViewModel.productList.vehicle_type_name +
        ...
        if (offerDetailViewModel.productList.vehicle_cat_name.isNullOrEmpty()){
            tvCategoryValue.visibility = View.GONE
            tvCategory.visibility = View.GONE
        }else{
            tvCategoryValue.text = offerDetailViewModel.productList.vehicle_cat_name
        }
