...
class SparePartsCarAccesoriesDetailActivity : AppCompatActivity(), ProductsImagesAdapter.ICustomListListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mContext = this@SparePartsCarAccesoriesDetailActivity
        init()
        clickListener()
    }
    ...
    private fun clickListener() {
        ...
        tvEdit.setOnClickListener {
            ...
            val intent = Intent(mContext, UpdateSparePartsCarAccesoriesActivity::class.java)
