...
class CompanyProfileActivity : AppCompatActivity(), CropHandler{
    ...
    private fun initView() {
        ...
        etcownername.keyListener = null
        etclandline.keyListener = null
        etcmobileno.keyListener = null
        etcaltmobileno.keyListener = null
        etcemail.keyListener = null
        etcwebsite.keyListener = null
        ethouseno.keyListener = null
        etcstreetnoname.keyListener = null
        etcLandmark.keyListener = null
        etcpincode.keyListener = null
        etcdetails.keyListener = null
    ...
    private fun clickListener() {
        ...
        ivEdit.setOnClickListener {
            val intent = Intent(mContext, UpdateCompanyProfileActivity::class.java)
            intent.putExtra(IntentKeyEnum.COMPANY_ID.name, companyProfileViewModel.companyId)
            intent.putExtra(IntentKeyEnum.CAT_ID.name, companyProfileViewModel.selectedCategoryFromHome)
