...
import kotlinx.android.synthetic.main.activity_regular_package_details.progressBar
import kotlinx.android.synthetic.main.activity_regular_package_details.tvSendCustomRequest
import org.json.JSONObject
import java.lang.Exception


class PackageDetailsActivity : AppCompatActivity()  , PaymentResultWithDataListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mContext = this@PackageDetailsActivity
        init()
    ...
    private fun clickListener() {
        ...
        tvBuyNow.setOnClickListener {
            ...
            packageDetailViewModel.companyRegister.package_id =
                packageDetailViewModel.selectedPackage.id
            packageDetailViewModel.companyRegister.custom_request = ""
            packageDetailViewModel.companyRegister.offer =
                packageDetailViewModel.selectedPackage.offer
            packageDetailViewModel.companyRegister.post =
                packageDetailViewModel.selectedPackage.post
            packageDetailViewModel.companyRegister.notification =
                packageDetailViewModel.selectedPackage.notification
            ...
            if (packageDetailViewModel.directPackage) {
                ...
                if (packageDetailViewModel.filePath.isNotEmpty()) {
...
//            }
        ...
        packageDetailViewModel.successRegisterLiveData.observe(
            ...
            androidx.lifecycle.Observer { companyRegister ->
                ...
                if (packageDetailViewModel.directPackage){
                    intent.putExtra(
                        IntentKeyEnum.DIRECT_PACKAGE.name,
                        "")
                }
        ...
        packageDetailViewModel.successCustomPackageRequestMessage.observe(
            ...
            androidx.lifecycle.Observer {
                ...
                if (packageDetailViewModel.directPackage){
                    intent.putExtra(IntentKeyEnum.PACKAGE_PURCHASED.name, "")
                }
    ...
    override fun onPaymentSuccess(paymentId: String?, p1: PaymentData?) {
        try{
            packageDetailViewModel.companyRegister.payment_id = paymentId
            packageDetailViewModel.apiSelectPackage(packageDetailViewModel.companyRegister)
