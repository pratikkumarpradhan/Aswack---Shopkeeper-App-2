...
class GarageListAdapter(
...
) : RecyclerView.Adapter<GarageListAdapter.CustomListViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CustomListViewHolder {
        val itemView =
            LayoutInflater.from(context).inflate(R.layout.row_my_products_garage, parent, false)
    ...
    override fun onBindViewHolder(holder: CustomListViewHolder, position: Int) {
        ...
        holder.tvProductCodeValue.text = itemList[position].product_code
        ...
        holder.itemView.setOnClickListener {
            iCustomListListener.onGarageProductSelected(itemList[position], position)
        }
    ...
    inner class CustomListViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val tvProductCodeValue : TextView= itemView.findViewById(R.id.tvProductCodeValue)
    ...
    interface ICustomListListener {
        fun onGarageProductSelected(productList: ProductList, position: Int)
