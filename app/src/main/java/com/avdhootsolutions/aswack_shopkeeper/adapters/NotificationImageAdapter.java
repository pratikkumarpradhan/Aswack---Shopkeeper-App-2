...
public class NotificationImageAdapter extends RecyclerView.Adapter {

    private Context mContext;
    private ViewHolder viewHolder;

    public NotificationImageAdapter(Context mContext) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.row_notification_image, parent, false));
    }
