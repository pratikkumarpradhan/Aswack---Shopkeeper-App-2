...
class ModelsAdapter(val context: Context, var dataSource: List<BrandsTypesModels.Types.Models>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        vh.label.text = dataSource.get(position).vehicle_model_name
