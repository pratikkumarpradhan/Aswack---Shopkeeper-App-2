...
class VehicleSellListAdapter(
    private val context: Context,
    private val iCustomListListener: ICustomListListener

) : RecyclerView.Adapter<VehicleSellListAdapter.CustomListViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CustomListViewHolder {
        val itemView =
            LayoutInflater.from(context).inflate(R.layout.row_product_sell_vehicle, parent, false)
    ...
    override fun onBindViewHolder(holder: CustomListViewHolder, position: Int) {
        ...
        holder.tvBrandValue.text = itemList[position].vehicle_brand_name
