...
class SellerWisePackageListAdapter(
    private val context: Context,
    private val iCustomListListener: ICustomListListener,

    ) : RecyclerView.Adapter<SellerWisePackageListAdapter.CustomListViewHolder>() {
...
//        holder.tvOfferPriceValue.text = itemList[position].offer_price
       // holder.tvSerialNumberValue.text = itemList[position].ser
        ...
        holder.tvStatus.setOnClickListener {
            iCustomListListener.onStatusSelected(itemList[position], position)
        }
    ...
    interface ICustomListListener {
        ...
        fun onStatusSelected(packageDataItem: PackageData, position: Int)
