...
class DialogCountryAdapter(val context: Context, var dataSource: List<Country>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        val vh: ItemHolder
        if (convertView == null) {
            view = inflater.inflate(R.layout.item_type_white_dialog, parent, false)
            vh = ItemHolder(view)
            view?.tag = vh
        } else {
            view = convertView
