...
class UploadedImagesAdapter(
...
) : RecyclerView.Adapter<UploadedImagesAdapter.CustomListViewHolder>() {
    ...
    override fun onBindViewHolder(holder: CustomListViewHolder, position: Int) {
        ...
        Picasso.get().load(itemList[position])
        ...
        holder.itemView.setOnClickListener {
            iCustomListListener.onImageSelected(position, itemList[position])
        }
    ...
    interface ICustomListListener {
        fun onImageSelected(position: Int, image: String)
