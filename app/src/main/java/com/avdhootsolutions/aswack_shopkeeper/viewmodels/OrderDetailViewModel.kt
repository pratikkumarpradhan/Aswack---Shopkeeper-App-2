...
class OrderDetailViewModel : ViewModel() {
    ...
    /**
     * Live data for order detail
     */
    var orderDetailLiveData: MutableLiveData<OrderRequest> = MutableLiveData<OrderRequest>()
     ...
     * Get user order list
     */
     fun getOrderDetails(productList: ProductList) {
        Log.e("request of get order details", Gson().toJson(productList))
            ...
            loginCallBackCall.enqueue(object : Callback<Datas?> {
                override fun onResponse(call: Call<Datas?>, response: Response<Datas?>) {
                    ...
                    Log.e("response of get order details", Gson().toJson(response.body()))
                    if (datas.status == true) {
                        ...
                        orderDetailLiveData.setValue(orderList[0])
        ...
        loginCallBackCall.enqueue(object : Callback<Datas?> {
            override fun onResponse(call: Call<Datas?>, response: Response<Datas?>) {
                ...
                if (datas.status == true) {
                    ...
                    errorMessage.value = datas.getMessage()
                }
            }
