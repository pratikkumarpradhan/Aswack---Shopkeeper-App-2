...
class AddTyreServiceViewModel : ViewModel() {
...
//                    apiGetYears()
    ...
    fun apiAddTyreServiceWithFile(spareParts: SpareParts, context: Context) {
...
//        }
        ...
        val tyre_width: okhttp3.RequestBody = okhttp3.RequestBody.create(
            MultipartBody.FORM, spareParts.tyre_width ?: "")

        val rim_diameter: okhttp3.RequestBody = okhttp3.RequestBody.create(
            MultipartBody.FORM, spareParts.rim_diameter ?: "")

        val aspect_ratio: okhttp3.RequestBody = okhttp3.RequestBody.create(
            MultipartBody.FORM, spareParts.aspect_ratio ?: "")

        val load_index: okhttp3.RequestBody = okhttp3.RequestBody.create(
            MultipartBody.FORM, spareParts.load_index ?: "")

        val speed_index: okhttp3.RequestBody = okhttp3.RequestBody.create(
            MultipartBody.FORM, spareParts.speed_index ?: "")

        val tyre_size: okhttp3.RequestBody = okhttp3.RequestBody.create(
            MultipartBody.FORM, spareParts.tyre_size ?: "")

        val is_tubeless: okhttp3.RequestBody = okhttp3.RequestBody.create(
            MultipartBody.FORM, spareParts.is_tubeless ?: "")

        val loginCallBackCall: Call<Datas> = MyApp.getInstance().getMyApi()
            .apiAddTyreServiceWithImage(image1,
                image2,
                image3,
                image4,
                image5,
